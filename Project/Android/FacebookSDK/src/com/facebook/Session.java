...
public class Session implements Serializable {
    ...
    public static boolean insideTabGroup;
    ...
    private boolean tryLoginActivity(AuthorizationRequest request) {
        ...
        try {
            request.getStartActivityDelegate().startActivityForResult(intent, request.getRequestCode(), insideTabGroup);
        ...
        AuthorizationClient.AuthorizationRequest getAuthorizationClientRequest() {
            AuthorizationClient.StartActivityDelegate delegate = new AuthorizationClient.StartActivityDelegate() {
                ...
                public void startActivityForResult(Intent intent, int requestCode) {
                    startActivityDelegate.startActivityForResult(intent, requestCode, insideTabGroup);
                }
